            ...
            <div class="relative">
                ...
                <select name="id_puskesmas" 
                    ...
                    @foreach($puskesmasList as $pusk)
                        <option value="{{ $pusk->id_puskesmas }}" 
                            {{ old('id_puskesmas', $posyandu->id_puskesmas) == $pusk->id_puskesmas ? 'selected' : '' }}>
        ...
        <div>
            ...
            <div class="relative">
                ...
                <textarea name="alamat" 
                    ...
                    class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#000878] focus:border-[#000878] @error('alamat') border-red-500 @enderror">{{ old('alamat', $posyandu->alamat) }}</textarea>
            </div>
            @error('alamat')
                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
            @enderror
