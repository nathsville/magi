            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <select name="kecamatan" 
                        ...
                        <option value="Bacukiki" {{ old('kecamatan', $posyandu->kecamatan) == 'Bacukiki' ? 'selected' : '' }}>Bacukiki</option>
                        <option value="Bacukiki Barat" {{ old('kecamatan', $posyandu->kecamatan) == 'Bacukiki Barat' ? 'selected' : '' }}>Bacukiki Barat</option>
                        <option value="Ujung" {{ old('kecamatan', $posyandu->kecamatan) == 'Ujung' ? 'selected' : '' }}>Ujung</option>
                        <option value="Soreang" {{ old('kecamatan', $posyandu->kecamatan) == 'Soreang' ? 'selected' : '' }}>Soreang</option>
                    </select>
