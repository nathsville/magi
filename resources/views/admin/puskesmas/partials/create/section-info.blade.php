    ...
    <div class="p-6 space-y-5">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <textarea name="alamat" 
                    ...
                    rows="3"
                    required
                    placeholder="Contoh: Jl. Andi Makkasau No. 5, Kelurahan Ujung Bulu"
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" 
                        name="kabupaten" 
                        id="kabupaten"
                        value="{{ old('kabupaten', 'Kota Parepare') }}"
                        required
        ...
        <div>
            ...
            @error('no_telepon')
                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
            @enderror
            <p class="mt-1 text-xs text-gray-500">Opsional. Format: 0421-xxxxx atau 08xxxxxxxxxx</p>
        </div>
    </div>
</div>