        ...
        <div>
            ...
            <div class="relative">
                ...
                <select name="tipe_data" id="tipe_data" required 
                    ...
                    <option value="Kriteria Stunting">Kriteria Stunting</option>
                    <option value="Status Gizi">Status Gizi</option>
                    <option value="Jenis Laporan">Jenis Laporan</option>
                    <option value="Tipe Notifikasi">Tipe Notifikasi</option>
                </select>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="nilai" id="nilai" value="{{ old('nilai') }}" required 
