<div class="flex items-center justify-between">
    <div>
        <h1 class="text-3xl font-bold text-gray-900">Kelola Intervensi Stunting</h1>
        <p class="text-gray-600 mt-1">Kelola dan pantau program intervensi untuk anak yang terindikasi stunting</p>
    </div>
